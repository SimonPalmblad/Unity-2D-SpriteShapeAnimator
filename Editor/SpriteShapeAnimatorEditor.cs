...
{
    [CustomEditor(typeof(SpriteShapeAnimator))]
    public class SpriteShapeAnimatorEditor : Editor
    {
        ...
        private SpriteShapeAnimator targetAnimationController;
        ...
        public void OnEnable()
        {
            ...
            targetAnimationController = target as SpriteShapeAnimator;
            //autoMatchProperty = serializedObject.FindProperty(nameof(targetAnimationController.autoMatchToSpline));

            var shapeAnimation = target as SpriteShapeAnimator;
        ...
        {
            if (targetAnimationController == null || EditorApplication.isPlaying)
            {
                return;
            }
        ...
        {          
            ...
            {
                var controller = target as SpriteShapeAnimator;
